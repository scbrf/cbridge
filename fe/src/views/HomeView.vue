<template>
  <main>
    <h1 class="text-4xl font-bold">Comment IPFS Bridge</h1>
    <div class="flex flex-col sm:flex-row items-center ">
      <div class="flex-1 py-4 leading-6 ">
        ...
        <div class="flex flex-col">
          ...
          <div v-if="cib" class="font-bold text-sm my-4 self-center justify-center flex ">CIB:<span
              class="text-green-600 font-bold mx-4">{{cib}}</span>
            <svg @click="copy2clipboard" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
              stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hover:text-gray-600 text-gray-400">
